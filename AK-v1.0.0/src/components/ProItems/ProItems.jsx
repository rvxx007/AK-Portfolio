...
const ProItems = (prop) => {
  ...
  return (
    ...
    {item.proType===proType &&
      ...
      <a href={item.gitlink} target="_blank" className="w-full text-center cursor-pointer rounded-md shadow-md text-xl py-2 px-4 bg-bgDark ">
          GitHub
      </a>
      <a href={item.livelink} target="_blank" className="w-full text-center cursor-pointer rounded-md shadow-md text-xl py-2 px-4 bg-bgDark ">
          View
      </a>
      </div>
  </motion.div>
